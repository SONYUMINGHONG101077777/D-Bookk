...
export default function TOC({
  ...
  return (
    <aside className="w-full md:w-80 md:flex-none border-r border-slate-200 bg-white p-4 sm:p-6 h-full overflow-y-auto flex flex-col justify-between">
      <main>
